...
>;
export type GetServiceMessagesSuspenseQueryHookResult = ReturnType<
  typeof useGetServiceMessagesSuspenseQuery
>;
...
export function useGetServiceMessageQuery(
  ...
  > &
    (
      | { variables: GetServiceMessageQueryVariables; skip?: boolean }
      | { skip: boolean }
    )
) {
  const options = { ...defaultOptions, ...baseOptions };
...
>;
export type GetServiceMessageSuspenseQueryHookResult = ReturnType<
  typeof useGetServiceMessageSuspenseQuery
>;
